...
(function(XHEDITOR, $, undefined){
	...
	$('script[src*=xheditor-all]').each(function(){
		var s=this.src;
...
//		emotPath=getLocalUrl(emotPath,'rel',urlBase?urlBase:null);//返回最短表情路径
		...
		this.init=function()
		{
			...
			headHTML='<meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><link rel="stylesheet" href="'+skinPath+'iframe.css"/><link rel="stylesheet" href="'+skinPath+'mathquill.css"/>';
