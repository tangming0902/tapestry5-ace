...
(function ($, undefined) {
    ...
    $.fn.select2.defaults = {
        ...
        formatNoMatches: function () { return "找不到相应记录"; },
        formatInputTooShort: function (input, min) { var n = min - input.length; return "请再输入 " + n + " 个文字"; },
        formatInputTooLong: function (input, max) { var n = input.length - max; return "请再删除 " + n + " 个文字"; },
        formatSelectionTooBig: function (limit) { return "您只能选择 " + limit + " 个选项"; },
